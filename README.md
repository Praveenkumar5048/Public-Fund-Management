...
> Below is a sample input file uploaded by authority during fund approval stage & output file generated by AI.
[input.pdf](files/input.pdf)
[output.pdf](files/output.pdf)

<embed src='files/input.pdf' type='application/pdf' width=700px height=700px />
